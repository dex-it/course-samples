...
namespace Topic_18_Serialization_XmlSerializer_
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			XmlSerializer xmlFormater = new XmlSerializer(typeof(Person));
			...
			// десериализация
			using (FileStream fileStream1 = new FileStream("person.xml", FileMode.OpenOrCreate))
			{
				Person person2 = (Person)xmlFormater.Deserialize(fileStream1);
